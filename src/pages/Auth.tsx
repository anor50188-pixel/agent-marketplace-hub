...
const Auth = () => {
    ...
    try {
      if (mode === "signup") {
        ...
        toast({
          ...
          description: "Emailingizni tekshiring va tasdiqlang.",
        });
      } else {
      ...
      toast({
        title: "❌ Xatolik",
        description: err.message || "Nimadir xato ketdi",
      });
    } finally {
      setLoading(false);
    }
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      toast({
        title: "❌ Google bilan kirish xatosi",
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/3 right-1/4 w-96 h-96 rounded-full bg-secondary/6 blur-[120px]" />
      </div>
      ...
      >
        ...
        <div className="rounded-2xl border border-border bg-card/80 backdrop-blur-sm p-6 shadow-lg">
          ...
          <Button
            ...
            disabled={loading}
            variant="outline"
            className="w-full h-11 rounded-xl border-border mb-4 text-sm font-medium"
          >
          ...
          <form onSubmit={handleEmailAuth} className="space-y-3">
                ...
                >
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full h-11 pl-10 pr-4 rounded-xl border border-border bg-muted/30 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/50"
                    />
                  </div>
                </motion.div>
              )}
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                minLength={6}
                className="w-full h-11 pl-10 pr-10 rounded-xl border border-border bg-muted/30 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/50"
              />
              <button
                type="button"
